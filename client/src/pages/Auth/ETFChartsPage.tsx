// src/pages/Auth/ETFChartsPage.tsx
import { useState } from "react";
import Chart from "react-apexcharts";
import type { ApexOptions } from "apexcharts";

export default function ETFChartsPage() {
  const [lineSeries] = useState<number[]>([10, 41, 35, 51, 49, 62, 69, 91, 148]);
  const [lineCategories] = useState<string[]>([
    "Jan",
    "Feb",
    "Mar",
    "Apr",
  ...
  return (
    <main className="main">
      <div className="pagetitle mb-4">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">ETF Charts</h1>
      ...
      <p className="dark:text-white">
        ETF market charts. You can check the{" "}
          ...
          <div className="col-lg-6">
            <div className="card">
              <div className="card-body">
                ...
                <Chart options={lineOptions} series={[{ name: "IBIT", data: lineSeries }]} type="line" height={350} />
              </div>
            </div>
          </div>
            ...
            <div className="card">
              <div className="card-body">
                <h5 className="card-title dark:text-white">
                  Roundhill Bitcoin Covered Call Strategy ETF (YBTC) Chart
                </h5>
